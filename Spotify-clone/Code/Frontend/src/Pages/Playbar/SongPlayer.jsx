    ...
    <div className="h-full w-full flex flex-row  text-black items-center ">
      <div className="song-details h-9/10 w-1/4 flex flex-row items-center gap-5 mx-3">
        ...
        <div className="artist-details">
          <div className="artist-details text-base font-medium text-white">
            {name}
          </div>
          <div className="collaborators-details text-xs text-customGray font-bold text-ellipsis overflow-hidden whitespace-nowrap">
            {artist.username}
          </div>
        </div>
      </div>
      ...
      <div className="h-full w-1/2 ">
        <div className="h-1/2 w-full flex flex-row justify-center items-center gap-5">
          ...
          <GiPreviousButton
            ...
            className="hover:cursor-pointer hover:text-white text-customGray h-6 w-6 h-"
          />

          {state.isPlaying ? (
            <FaPause
              className="hover:cursor-pointer  h-8 w-8 text-white"
          ...
          <GiNextButton
            ...
            className="hover:cursor-pointer hover:text-white text-customGray  h-6 w-6"
          />
          <MdOutlineReplay
