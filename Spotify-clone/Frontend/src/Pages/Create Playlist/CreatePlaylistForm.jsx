        ...
        <div className="form mt-8 flex flex-col gap-2">
          <div className={"w-full flex flex-col gap-2 mb-4 "}>
            ...
            <input
              ...
              className="border-2 border-solid border-gray-400 p-3 rounded text-black placeholder-gray-500"
            />
          </div>
          {errors.name && (
            <div className="text-red-500 txt-sm">{errors.name.message}</div>
          )}
          ...
          {errors.collaborators && (
            <div className="text-red-500 txt-sm">
          ...
          <div className="flex flex-col justify-between gap-3">
            ...
            <div>
              <button
                ...
                className="border-2 border-solid border-black py-2 px-4 bg-white text-black rounded-full font-semibold p-3"
              >
