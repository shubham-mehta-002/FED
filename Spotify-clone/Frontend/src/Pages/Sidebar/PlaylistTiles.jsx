 ...
 const { state, dispatch } = useAppContext();
  ...
  return (
    <div
      ...
      className={` 
      ${state.currentPlaylistID === playlist._id ? "bg-customGray ": "bg-inherit"}
      ...
      <div className="h-full w-3/5 flex flex-col justify-around ">
        ...
        <div className="text-sm flex flex-row gap-4">
          ...
          <span>
            ...
            <button className="hover:cursor-default  border-2 px-2  border-black border-solid bg-customGray rounded-full">
