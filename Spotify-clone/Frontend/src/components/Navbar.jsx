...
export function Navbar()
{
    ...
    return(
        <div className="h-1/10 w-full bg-customOpacityBlackBg rounded flex flex-row justify-between items-center gap-4 bg-blend-normal">
            ...
            {loginState && <button><img className="hover:scale-110 h-10 w-10 rounded-full bg-white"src={user}/></button>}
