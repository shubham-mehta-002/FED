            ...
            <div className='w-full h-full flex flex-col items-center'>
                <div className='login-details flex  items-center flex-col w-1/3'>
                    ...
                    <div className='h-0 w-full border-2 border-solid border-b-gray-400 mt-4'>
                        ...
                        <button className='border-2 border-solid border-gray-400 w-full px-2 py-4 mb-2 rounded-full text-l font-semibold text-gray-500'
                        onClick={()=>navigate('/login')}>
                            LOG IN INSTEAD
                        </button>

                        <div className='flex justify-end text-sm text-red-500 mb-4'><NavLink to='/'>Go to home page</NavLink></div>
